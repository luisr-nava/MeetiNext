import CommunityActionsPanel from "@/src/features/comminities/components/CommunityActionsPanel";
import UpcomingCommunityMeetis from "@/src/features/comminities/components/UpcomingCommunityMeetis";
...
const getCommunityIdCache = cache(async (id: string) => {
...
export async function generateMetadata({
  ...
  const community = await getCommunityIdCache(id);
  return {
          ...
          <div className="lg:col-span-2 space-y-5">
            <div className="relative size-64 mx-auto aspect-square overflow-hidden rounded-full">
              <Image
                ...
                alt={`Imagen de ${community.data.name}`}
                width={600}
                height={600}
            ...
            <p className="text-gray-600 text-sm text-center">
              ...
              {pluraliza("Miembro", community.memberCount)}
            </p>
          </div>
